...
const Job = () => {
    // Array of projects
   const projects = [
    { id: 1, title: 'digitalmarket', description: 'Navata Tech', link: '/Project3' },
    { id: 2, title: 'website', description: 'Tech Solutions', link: '/Project3' },
    { id: 3, title: 'photograph', description: 'NextGen Innovations', link: '/Project3' },
    { id: 4, title: 'app developer', description: 'AI Development', link: '/Project3' },
    { id: 5, title: 'web design', description: 'Mobile App', link: '/Project3' },
    { id: 6, title: 'softwere developer', description: 'Web Services', link: '/Project3' },
  ];
