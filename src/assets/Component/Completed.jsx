...
const Completed = () => {
  // Array of projects
  const projects = [
    { id: 1, title: 'Project 1', description: 'Navata Tech', link: '/Project1' },
    { id: 2, title: 'Project 2', description: 'Tech Solutions', link: '/Project1' },
    { id: 3, title: 'Project 3', description: 'NextGen Innovations', link: '/Project1' },
    { id: 4, title: 'Project 4', description: 'AI Development', link: '/Project1' },
    { id: 5, title: 'Project 5', description: 'Mobile App', link: '/Project1' },
    { id: 6, title: 'Project 6', description: 'Web Services', link: '/Project1' },
  ];
