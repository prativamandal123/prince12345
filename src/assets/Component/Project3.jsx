        ...
        <div className="container">
          <div className="row align-items-center py-4">
            ...
            <div className="col-12 col-md-6 mb-4 mb-md-0">
              <h2 className="fw-bold fs-3 mb-3">job detail</h2>
            ...
            <div className="col-12 col-md-6">
              <div className="image-container shadow-sm rounded overflow-hidden">
                <img
                  src="https://img.freepik.com/free-photo/modern-equipped-computer-lab_23-2149241221.jpg?ga=GA1.1.1455983656.1731581090&semt=ais_hybrid"
                  alt="Project Image"
                  className="img-fluid"
