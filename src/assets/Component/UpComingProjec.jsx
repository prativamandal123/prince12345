...
const UpComingProjec = () => {
     // Array of projects
   const projects = [
    { id: 1, title: 'upCoingProject 1', description: 'Navata Tech', link: '/Project2' },
    { id: 2, title: 'upCoingProject 2', description: 'Tech Solutions', link: '/Project2' },
    { id: 3, title: 'upCoingProject 3', description: 'NextGen Innovations', link: '/Project2' },
    { id: 4, title: 'upCoingProject 4', description: 'AI Development', link: '/Project2' },
    { id: 5, title: 'upCoingProject 5', description: 'Mobile App', link: '/Project2' },
    { id: 6, title: 'upCoingProject 6', description: 'Web Services', link: '/Project2' },
  ];
