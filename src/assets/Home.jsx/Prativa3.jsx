        ...
        <div className='container '>
         <div className='row align-items-center '>
            ...
            <div className='col-12 col-md-6 '>
                <h2 className='fw-bold fs-1'>John Smith</h2>
              <p className='fs-4'>Pediatrician</p>
            ...
            <div className='col-12 col-md-6'>
              <div className='image-container'>
                <img 
                  src="https://img.freepik.com/free-photo/beautiful-girl-stands-near-walll-with-leaves_8353-5377.jpg" 
                  alt="IT Concept" 
                  className="img-fluid" 
