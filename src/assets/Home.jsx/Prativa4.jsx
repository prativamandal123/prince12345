        ...
        <div className='container '>
         <div className='row align-items-center '>
            ...
            <div className='col-12 col-md-6 '>
                <h2 className='fw-bold fs-1'>Walter White</h2>
              <p className='fs-4'>"Officer</p>
            ...
            <div className='col-12 col-md-6'>
              <div className='image-container'>
                <img 
                  src="https://img.freepik.com/free-photo/portrait-beautiful-brunette-model-summer-city-woman-straw-hat_1157-39801.jpg" 
                  alt="IT Concept" 
                  className="img-fluid" 
